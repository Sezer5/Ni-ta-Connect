...
class Ekstreler extends CI_Controller {
	...
	public function index()
	{
		...
		$url = "http://10.51.0.24:8091/api/risk/GetCariExtre?cariRef=" . $cariRef;
		...
		// 4. Yanıtı işle
		$data['ekstre_verileri'] = array();

		if ($http_code == 200) {
			$data['ekstre_verileri'] = json_decode($response, true);
		} else {
