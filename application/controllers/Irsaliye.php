...
class Irsaliye extends CI_Controller {
	...
	public function index()
	{
		...
		$url = "http://10.51.0.24:8091/api/irsaliye/GetCariAcikIrsaliye?cariRef=" . $cariRef;
		...
		// 4. Yanıtı işle
		$data['irsaliye_verileri'] = array();

		if ($http_code == 200) {
			$data['irsaliye_verileri'] = json_decode($response, true);
		} else {
        ...
        $this->load->view('irsaliyeler',$data);
